...
# 3. Load Excel (replace with your actual file path)
...
# 7. Reorder columns so foresight_keyword and foresight_category come right after summary
cols = list(df.columns)
summary_idx = cols.index("summary")

# Move foresight_keyword and foresight_category right after summary
for col in ["foresight_category", "foresight_keyword"]:
    cols.insert(summary_idx + 1, cols.pop(cols.index(col)))
